...
OUTPUT_CSV = "/home/master/wzheng/projects/htcondor_eda/results/typical_programs_analysis/superstar_records.csv"
TARGET_NAME = "superstar"
...
if df_filtered.empty:
    ...
    print(f"superstar finish, total {len(df_filtered)} records,save to {OUTPUT_CSV}")
