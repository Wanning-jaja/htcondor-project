...
OUTPUT_CSV = "/home/master/wzheng/projects/htcondor_eda/results/typical_programs_analysis/star_errsolver_records.csv"
TARGET_NAME = "star_errsolver.sh"
...
if df_filtered.empty:
    ...
    print(f"star_errsolver.sh finish, total {len(df_filtered)} records, save to {OUTPUT_CSV}")
