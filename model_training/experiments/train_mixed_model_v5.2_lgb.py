...
MODEL_DIR   = "/home/master/wzheng/projects/model_training/models/v5.2_lgb"
REPORT_DIR  = "/home/master/wzheng/projects/model_training/reports/v5.2_lgb"
...
#    当没有正式验证集时，按时间从训练集中“末端切一段”做内部留出集（保持时间有序）。
...
#        )
        ...
        # 纯 train-only：不跑 Optuna、不早停，固定一组保守参数
        best_params = {
            "learning_rate": 0.05,
            "max_depth": 8,
            "num_leaves": 63,
...
sum_path = os.path.join(REPORT_DIR, "v5.2_lgb_evaluation_summary.csv")
