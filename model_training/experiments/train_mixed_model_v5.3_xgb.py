...
MODEL_DIR   = "/home/master/wzheng/projects/model_training/models/v5.3_xgb"
REPORT_DIR  = "/home/master/wzheng/projects/model_training/reports/v5.3_xgb"
...
def bucket_penalized_rmse(y_true, y_pred, lam: float = 0.25):
    ...
    off = np.abs(_bucketize(y_pred) - _bucketize(y_true))
    penalty = (off * lam * 1000).mean()
    return rmse + penalty
...
sum_path = os.path.join(REPORT_DIR, "v5.3_xgb_evaluation_summary.csv")
