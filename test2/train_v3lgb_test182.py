...
MODEL_DIR    = "/home/master/wzheng/projects/test2/models/v3_182_lgb"
REPORT_DIR   = "/home/master/wzheng/projects/test2/reports/v3_182_lgb"
...
TRAIN_WINDOW_DAYS: 182 | None = None
...
pd.DataFrame(summary_rows).to_csv(os.path.join(REPORT_DIR, "v3_lgb_182_summary.csv"), index=False)
print("Saved summary to:", os.path.join(REPORT_DIR, "v3_lgb_182_summary.csv"))
