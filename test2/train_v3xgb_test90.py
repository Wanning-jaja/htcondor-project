...
MODEL_DIR    = "/home/master/wzheng/projects/test2/models/v3_90_xgb"
REPORT_DIR   = "/home/master/wzheng/projects/test2/reports/v3_90_xgb"
...
sum_df.to_csv(os.path.join(REPORT_DIR, "v3_90_xgb_summary.csv"), index=False)
print("Saved summary to:", os.path.join(REPORT_DIR, "v3_90_xgb_summary.csv"))
